...
from utils.enums import HostRiskLevel, KeywordCategory, HostCategory, KeywordSearchPlace
...
class Keyword(models.Model):
    ...
    search_place = models.CharField(
        _("Место поиска"),
        max_length=20,
        db_index=True,
        choices=KeywordSearchPlace.choices,
        default=KeywordSearchPlace.ALL,
    )
